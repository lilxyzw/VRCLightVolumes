...
public static class LightVolumeDataSorter {
    ...
    public static void GetData(List<LightVolumeData> sortedData, out Vector4[] invLocalEdgeSmooth, out Matrix4x4[] invWorldMatrix, out Vector4[] uvwMin, out Vector4[] uvwMax) {
