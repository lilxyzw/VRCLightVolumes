...
namespace VRCLightVolumes
{
    ...
    {
        // Compute [0; 1] occlusion values for each probe given a specific pixel light
        // private static float[] ComputeOcclusionFactors(Vector3[] probePositions, Vector3 lightPosition, float lightRadius)
        // {
        //     // Get required assets
